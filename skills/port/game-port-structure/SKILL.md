...
because the project retained an obsolete wrapper ceiling. Follow the canonical signing instructions
in `instructions/AGENTS.md` for existing GitHub secrets, local test keys, and release identity.
